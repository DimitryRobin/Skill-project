...
namespace Skill_Project.FormsCompetence.BoutonAnime
{
    public partial class Animated_Button2 : Control
    {
        #region Frame
        ...
        public Animated_Button2()
        {
            InitializeComponent();

            this.DoubleBuffered = true;

            MouseOverFrame = new Frame(Skill_Project.Properties.Resources.degrade1, 25, 0, new Size(100, 30));
            MouseDownFrame = new Frame(Skill_Project.Properties.Resources.degrade1bis, 25, 0, new Size(100, 30));
