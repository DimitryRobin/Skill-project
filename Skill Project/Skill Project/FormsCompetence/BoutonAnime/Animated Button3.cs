...
{
    public partial class Animated_Button3 : Control
    {
        #region Frame
        ...
        public Animated_Button3()
        {
            InitializeComponent();

            this.DoubleBuffered = true;

            MouseOverFrame = new Frame(Skill_Project.Properties.Resources.degrade2bis, 25, 0, new Size(100, 30));
            MouseDownFrame = new Frame(Skill_Project.Properties.Resources.degrade2, 25, 0, new Size(100, 30));
